...
function App() {
  ...
  const gameWords: GameWords[] = [
    ...
    { word: "craft", game: "final fantasy 14" },
    ...
    { word: "valor", game: "final fantasy 14" },
    { word: "flame", game: "final fantasy 14" },
    { word: "forge", game: "final fantasy 14" },
    { word: "shade", game: "final fantasy 14" },
    { word: "chaos", game: "final fantasy 14" },
    { word: "wards", game: "final fantasy 14" },
    { word: "whale", game: "final fantasy 14" },
    { word: "flint", game: "final fantasy 14" },
    { word: "lunar", game: "final fantasy 14" },
    { word: "ivory", game: "final fantasy 14" },
    { word: "bliss", game: "final fantasy 14" },

    { word: "beast", game: "bloodborne" },
    { word: "blood", game: "bloodborne" },
    { word: "blade", game: "bloodborne" },
    { word: "ghost", game: "bloodborne" },
    { word: "grave", game: "bloodborne" },
    { word: "chaos", game: "bloodborne" },
    { word: "souls", game: "bloodborne" },
    { word: "ruins", game: "bloodborne" },
    { word: "torch", game: "bloodborne" },
    { word: "stars", game: "bloodborne" },
    { word: "curse", game: "bloodborne" },
    ...
    { word: "coven", game: "bloodborne" },
    { word: "sword", game: "bloodborne" },
    { word: "helms", game: "bloodborne" },
    { word: "flame", game: "bloodborne" },
    { word: "order", game: "bloodborne" },
    { word: "quest", game: "bloodborne" },
    { word: "glory", game: "bloodborne" },
    { word: "earth", game: "bloodborne" },
    { word: "shade", game: "bloodborne" },
    { word: "rites", game: "bloodborne" },
    { word: "havoc", game: "bloodborne" },
    { word: "plume", game: "bloodborne" },
    ...
    { word: "sheds", game: "stardew valley" },
    ...
    { word: "beams", game: "monster hunter" },
    { word: "lavas", game: "monster hunter" },
    { word: "snipe", game: "monster hunter" },
    { word: "slash", game: "monster hunter" },
    { word: "wrath", game: "monster hunter" },
    { word: "flame", game: "monster hunter" },
    { word: "melee", game: "monster hunter" },
    { word: "shear", game: "monster hunter" },
    { word: "spear", game: "monster hunter" },
